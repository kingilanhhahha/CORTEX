...
export default {
	...
	theme: {
		...
		screens: {
			...
			'2xl': '1400px',
			'3xl': '1600px',
			// Mobile-first approach with landscape support
		...
		extend: {
			...
			keyframes: {
				...
				'nebula-pulse': {
					'0%, 100%': { 
						boxShadow: '0 0 30px hsl(var(--nebula-pink) / 0.4)',
						transform: 'scale(1)'
					},
					'50%': { 
						boxShadow: '0 0 50px hsl(var(--nebula-pink) / 0.7)',
			...
			animation: {
				...
				'hyperspace-jump': 'hyperspace-jump 0.8s ease-out forwards'
			}
		}
	},
