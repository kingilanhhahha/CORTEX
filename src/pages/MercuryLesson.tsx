...
const MercuryLesson: React.FC = () => {
  ...
  const toggleAudio = (audioSrc?: string, sequence?: string[]) => {
    ...
    if (audioSrc && audioSrc !== currentAudioSrc) {
      ...
      // Use conversation audio hook for automatic ducking
      playConversationAudio(audioSrc, 0.95);
      setIsAudioPlaying(true);
      return;
    }
    
    // For existing audio, use the old logic
    if (audioRef.current) {
      if (isAudioPlaying) {
  ...
  const sections = [
    {
      ...
      content: (
        <div className="space-y-6">
          <div className="bg-gradient-card/95 backdrop-blur-md border border-white/30 rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="flex items-center gap-2 bg-white/40 border-white/40 text-white hover:bg-white/50"
              >
            ...
            <div className="bg-white/25 rounded-lg p-4 mb-4 border border-white/30">
      ...
      content: (
        <div className="space-y-6">
          <div className="bg-gradient-card/95 backdrop-blur-md border border-white/30 rounded-lg p-6">
            ...
            <div className="bg-white/25 rounded-lg p-4 mb-6 border border-white/30">
            ...
            <div className="bg-white/25 rounded-lg p-4 mt-6 border border-white/30">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <div className="bg-white/40 rounded-xl p-4 border border-white/40 backdrop-blur-sm">
            ...
            {showQuestionFeedback[1] && questionsAnswered[1] && !questionsAnswered[1].correct && (
              <div className="bg-red-500/40 rounded-lg p-4 border border-red-300/30 mt-3">
                ...
                <div className="text-white/90 text-sm space-y-3">
                  <div className="bg-white/40 rounded p-3">
            ...
            {showQuestionFeedback[1] && questionsAnswered[1] && questionsAnswered[1].correct && (
              <div className="bg-green-500/40 rounded-lg p-4 border border-green-300/30 mt-3">
            ...
            {showQuestionFeedback[2] && questionsAnswered[2] && !questionsAnswered[2].correct && (
              <div className="bg-red-500/40 rounded-lg p-4 border border-red-300/30 mt-3">
                ...
                <div className="text-white/90 text-sm space-y-3">
                  ...
                  <div className="bg-green-500/40 rounded p-2 border border-green-300/30">
          ...
          {quizCompleted && (
            <div className="bg-gradient-to-br from-indigo-500/20 to-cyan-500/20 rounded-xl p-6 border border-indigo-300/30">
              ...
              {getPerformanceSummary().percentage >= 70 ? (
                <div className="bg-green-500/40 rounded-lg p-4 mt-4 border border-green-300/30 text-center">
                  <p className="text-green-200 font-semibold">🎊 Well done! You're ready to continue to the next lesson!</p>
                </div>
              ) : (
                <div className="bg-yellow-500/40 rounded-lg p-4 mt-4 border border-yellow-300/30 text-center">
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10">
        {/* Header */}
        <motion.header 
          className="p-6 border-b border-white/30 backdrop-blur-sm"
        ...
        >
          <div className="container mx-auto flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="flex gap-2">
                <Button 
                  ...
                  className="flex items-center gap-2 text-white hover:bg-white/40"
                >
                  <ArrowLeft size={16} />
                ...
                <Button 
                  ...
                  size="sm" 
                  onClick={handleGoBack}
                  className="text-white border-white/40 hover:bg-white/40"
                >
            ...
            <div className="flex items-center gap-2">
              <Button variant="outline" onClick={() => navigate('/rpg')} className="text-white border-white/40 hover:bg-white/40">
                <Home size={16} />
              </Button>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
                  ...
                  <motion.button
                    ...
                    className={`p-4 rounded-lg border transition-all ${
                      currentSection === index
                        ...
                        : 'bg-white/25 border-white/30 text-white/70 hover:bg-white/40'
                    }`}
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={`p-2 rounded-lg ${
                        currentSection === index ? 'bg-white/50' : 'bg-white/40'
                      }`}>
                        {section.icon}
                      </div>
            ...
            >
              <Button
                ...
                variant="outline"
                className="text-white border-white/40 hover:bg-white/40 disabled:opacity-50"
              >
        ...
        <AlertDialogContent className="border-cosmic-purple/20 bg-cosmic-dark/95 backdrop-blur-md">
          ...
          <AlertDialogFooter className="flex gap-3 justify-center">
            <AlertDialogCancel 
              ...
              className="bg-transparent border-white/40 text-white hover:bg-white/40"
            >
