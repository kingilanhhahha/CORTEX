...
import GlobalScrollButtons from "@/components/common/GlobalScrollButtons";
          ...
          <MusicProvider>
            <TooltipProvider>
              ...
              <BrowserRouter>
                ...
                <BackgroundMusic />
                {/* Global scroll buttons with keyboard support */}
                <GlobalScrollButtons />
                <Routes>
              <Route path="/" element={<LoginPage />} />
              <Route path="/student" element={<DrawingSolverPage />} />
